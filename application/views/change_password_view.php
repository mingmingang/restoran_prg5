                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo site_url('UserC/update_password'); ?>" method="post">
                                ...
                                <button type="submit" class="btn btn-primary w-100 rounded-3">Change Password</button>
                            </form>
                            <p class="mt-3 text-center">
                                Kembali ke <a style="color: orange;" href="<?php echo site_url('UserC/login'); ?>"><strong>Login</strong></a>
                            </p>
                        </div>
                    </div>
                </div>
