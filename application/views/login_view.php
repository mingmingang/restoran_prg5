                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header text-center">
                            <h5 class="mb-0">Login</h5> <!-- Tambahkan margin bawah pada judul -->
                        </div>
                        <div class="card-body">
                            <?php if ($this->session->flashdata('error')): ?>
                                <div class="alert alert-danger"><?php echo $this->session->flashdata('error'); ?></div>
                            <?php endif; ?>
                            <form action="<?php echo site_url('UserC/login_user'); ?>" method="post">
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-primary w-100 rounded-3">Login</button> <!-- Menggunakan lebar penuh untuk tombol -->
                            </form>
                            <p class="mt-3 text-center">
                                Belum punya akun? <a style="color:orange;" href="<?php echo site_url('UserC/register'); ?>"><strong>Daftar di sini</strong></a>
                            </p>
                            <p class="mt-3 text-center">
                                Lupa password? <a style="color:orange;" href="<?php echo site_url('UserC/change_password'); ?>"><strong>Ganti Password di sini</strong></a>
                            </p>
                        </div>
                    </div>
                </div>
