                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row gx-3 h-100 align-items-center">
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="<?php echo base_url('restaurant/assets/img/gallery/cheese-burger.png')?>" alt="..." />
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="<?php echo base_url('restaurant/assets/img/gallery/toffes-cake.png')?>" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="<?php echo base_url('restaurant/assets/img/gallery/dancake.png')?>" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="<?php echo base_url('restaurant/assets/img/gallery/crispy-sandwitch.png')?>" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="<?php echo base_url('restaurant/assets/img/gallery/thai-soup.png')?>" alt="..." />
                          <div class="card-body ps-0">
